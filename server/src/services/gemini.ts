...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    responda a pergunta de forma clara e precisa em português do Brasil.
    ...
    Instruções:
    - Use apenas apenas informações contidas no contexto enviado;
    - Se a resposta não for encontrada no contexto, 
    apenas responda que não possui informações suficientes para responder;
    - Seja objetivo;
